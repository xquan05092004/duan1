                      ...
                      <?php if (!empty($categories) && is_array($categories)): ?>
                        <?php foreach ($categories as $category): ?>
                          <tr>
                            <td><?= $category['id'] ?></td>
                            <td><?= $category['name'] ?></td>
                            <td><a href="index.php?page=edit_categories&id=<?= $category['id'] ?>" class="btn btn-success btn-sm">Sửa</a></td>
                            <td><a href="index.php?page=delete_categories&id=<?= $category['id'] ?>"
