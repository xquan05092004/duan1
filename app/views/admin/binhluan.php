                    ...
                    <?php foreach ($comments as $c): ?>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><?= $c['content'] ?></td>
                          <td>
                            <form method="POST" action="index.php?page=ttbinhluan" style="display:inline;">
                              <?php if ($c['status'] != 'completed' && $c['status'] != 'canceled'): ?>
                          ...
                          <td><?= $c['created_at'] ?></td>
                          <td>
                            <a class="btn btn-success" href="index.php?page=xoabinhluan&id=<?= $c['id'] ?>" onclick="return confirm('Xóa bình luận?')">Xóa</a>                    
                          <button type="submit" class="btn btn-primary" style="margin: bottom 20px; ;">Cập nhật</button>
