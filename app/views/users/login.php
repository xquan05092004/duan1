...
>
  ...
  <head>
    ...
    />
    <link
      href="assets/templates/thoitrang05/assets/lib/bootstrap-datepicker/bootstrap-datepicker.min.css"
      rel="stylesheet"
      type="text/css"
    />
    <link
      href="assets/templates/thoitrang05/assets/lib/bootstrap-select/bootstrap-select.css"
      rel="stylesheet"
      type="text/css"
    />
    <link
      href="assets/templates/thoitrang05/assets/lib/jquery-ui/jquery-ui.min.css"
      rel="stylesheet"
      type="text/css"
    />
    <link
      href="assets/templates/thoitrang05/assets/css/catalogue.css"
      rel="stylesheet"
      type="text/css"
    />
    <link
      href="assets/templates/thoitrang05/assets/css/comment-rating.css"
      rel="stylesheet"
      type="text/css"
    />
    <link
      href="assets/templates/thoitrang05/assets/css/member.css"
      rel="stylesheet"
      type="text/css"
    />
    <link
      href="assets/templates/thoitrang05/assets/css/order.css"
      rel="stylesheet"
      type="text/css"
    />
    ...
    <style type="text/css">
      ...
      @font-face {
        ...
        font-weight: 300;
        font-display: block;
        src: url("assets/templates/thoitrang05/assets/fonts/fa-light-300.html")
            format("woff2"),
          url("assets/templates/thoitrang05/assets/fonts/fa-light-300.ttf")
            format("truetype");
        font-display: swap;
      }
      @font-face {
        ...
        font-weight: 900;
        font-display: block;
        src: url("assets/templates/thoitrang05/assets/fonts/fa-solid-900.html")
            format("woff2"),
          url("assets/templates/thoitrang05/assets/fonts/fa-solid-900.ttf")
            format("truetype");
        font-display: swap;
      }
      @font-face {
        ...
        font-weight: 400;
        font-display: block;
        src: url("assets/templates/thoitrang05/assets/fonts/fa-brands-400.html")
            format("woff2"),
          url("assets/templates/thoitrang05/assets/fonts/fonts/fa-brands-400.html")
            format("truetype");
        font-display: swap;
      }
      /* ]]> */
  ...
  <body class="member">
              ...
              <div class="menu-container menu-pc">
                ...
                <nav class="menu-section" nh-menu="sidebar" menu-type="main">
                  ...
                  <ul>
                    <li class="">
                      <a href="../index.html">
                        Trang chủ<span class="fa-light fa-chevron-down"></span
                      ></a>
                    </li>
                    <li class="position-relative has-child">
                      <a href="../san-pham.html"
                        ...
                        ></span></a
                      ><span class="grower" nh-toggle="emuqg5k26i"></span>
                      <ul
                      ...
                      >
                        ...
                        <li class=" ">
                          <a class="menu-link" href="../quan-nam.html"
                            >Quần Nam</a
                          >
                        </li>
                      </ul>
                    ...
                    <li class="">
                      <a href="../trang-tin-tuc.html"
                        >Bài viết<span class="fa-light fa-chevron-down"></span
                      ></a>
                    </li>
                    <li class="">
                      <a href="../lien-he.html"
                        >Liên hệ<span class="fa-light fa-chevron-down"></span
                      ></a>
                    </li>
                  </ul>
                </nav>
            ...
            <div nh-block="qhdw2uy" nh-block-cache="true" class="">
              <div class="logo-section">
                <a href="../index.html"
                  ><img
                    class="img-fluid"
                    src="../templates/thoitrang05/assets/media/logo/logo_black.png"
                    alt="logo"
                /></a>
              </div>
            </div>
          ...
          <div class="col-md-4 col-12">
            <div nh-block="8bxkyf0" nh-block-cache="true" class="">
              <div class="entire-action-header entire-action-search">
                <span class="btn-action-header btn-mini-search"
                  ><img
                    src="../templates/thoitrang05/assets/media/icon/search.svg"
                    class="icon"
                /></span>
                <form
            ...
            <div nh-block="mgqafzd" nh-block-cache="true" class="float-right">
              <div class="entire-action-header">
                <a
                  ...
                  ><span wishlist-total="all" class="items-number">0</span>
                </a>
              </div>
            </div>
            ...
            <div class="col-md-3 col-12">
              <div nh-block="8z96myo" nh-block-cache="true" class="">
                <div class="menu-footer">
                  ...
                  <ul>
                    <li class="">
                      <a href="../mailto_%20contact%40sm4s.html"
                        >Email: contact@sm4s.vn</a
                      >
                    </li>
                    <li class="">
                      <a href="../tel_0901191616.html"
                        >Hotline(Zalo): 0901191616</a
                      >
                    </li>
                    <li class="">
                      <a href="../tel_1900%206680.html"
                        >Điện thoại: 1900 6680</a
                      >
                    </li>
                  </ul>
                </div>
                ...
                <div class="entire-info-website">
                  ...
                  <address>
                    <p>
                      <span class="d-inline-block mr-2 font-weight-bold"
                        >HCM:</span
                      >927/1 CMT8, Phường 7, Quận Tân Bình, TP.HCM
                    </p>
                  </address>
                  <address>
                    <p>
                      <span class="d-inline-block mr-2 font-weight-bold"
                        >Vinh:</span
                      >Tầng 2 chung cư saigonsky, Ngõ 26, Nguyễn Thái Học,
    ...
    <div
      ...
      style="z-index: 100000; right: 0; top: 0"
    ></div>
    ...
    <script
      src="assets/templates/thoitrang05/assets/lib/inputmask/jquery.inputmask.min.js"
      type="text/javascript"
    ></script>
    <script
      src="assets/templates/thoitrang05/assets/lib/lightgallery-all.min.js"
      type="text/javascript"
    ></script>
    <script
      src="assets/templates/thoitrang05/assets/lib/bootstrap-select/bootstrap-select.min.js"
      type="text/javascript"
    ></script>
    <script
      src="assets/templates/thoitrang05/assets/lib/bootstrap-datepicker/bootstrap-datepicker.min.js"
      type="text/javascript"
    ></script>
    <script
      src="assets/templates/thoitrang05/assets/lib/bootstrap-datepicker/locales/vi.js"
      type="text/javascript"
    ></script>
    <script
      src="assets/templates/thoitrang05/assets/lib/tocbot/tocbot.min.js"
      type="text/javascript"
    ></script>
    ...
    <script
      src="assets/templates/thoitrang05/assets/js/catalogue.js"
      type="text/javascript"
    ></script>
    <script
      src="assets/templates/thoitrang05/assets/js/comment.js"
      type="text/javascript"
    ></script>
  </body>
