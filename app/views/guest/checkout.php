...
<body>
                ...
                <div class="col-md-4 col-12">
                    <div nh-block="hzfxs24" nh-block-cache="true" class="">
                        <div class="menu-container menu-pc">
                            <a class="btn-menu-mobile" nh-menu="btn-open" menu-type="main" href="javascript:;"><i
                                    class="fa-light fa-bars-staggered"></i></a>
                            <div class="back-drop"></div>
                            <nav class="menu-section" nh-menu="sidebar" menu-type="main">

                                <div class="menu-top">
                                    <span class="menu-header">Menu</span><a href="javascript:;" nh-menu="btn-close"
                                ...
                                <ul>
                                    ...
                                    <li class="">
                                        <a href="trang-tin-tuc.html">Bài viết<span
                                                class="fa-light fa-chevron-down"></span></a>
                                    </li>
                                    <li class="">
                ...
                <div class="col-md-4 col-12">
                    <div nh-block="qhdw2uy" nh-block-cache="true" class="">
                        <div class="logo-section">
                            <a href="index.php?page=home"><img class="img-fluid"
                    ...
                    <div nh-block="8bxkyf0" nh-block-cache="true" class="">
                        <div class="entire-action-header entire-action-search">
                            <span class="btn-action-header btn-mini-search"><img
                                    ...
                                    class="icon" /></span>
                            <form class="form-search position-relative" action="index.php" method="get"
                                autocomplete="off">
                                <input type="hidden" name="page" value="search">
                                <div class="input-group">
                                    <div class="input-group-append">
                                        <button nh-btn-submit class="btn btn-submit" type="submit">
                                            <img src="assets/templates/thoitrang05/assets/media/icon/search.svg"
                                                class="icon" />
                                        </button>
                                    </div>
                                    <input nh-auto-suggest="product" name="q" placeholder="Từ khóa tìm kiếm" type="text"
                        ...
                        <form action="index.php?page=process_checkout" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="address" class="form-control" rows="3"
                                    required><?php echo isset($_SESSION['user']) ? $_SESSION['user']['address'] : ''; ?></textarea>
                            </div>
    ...
    <script src="assets/templates/thoitrang05/assets/lib/jquery-lazy/jquery.lazy.plugins.min.js" type="text/javascript">
    </script>
